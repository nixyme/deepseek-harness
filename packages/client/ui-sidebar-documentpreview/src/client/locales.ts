...
export const zh = {
  ...
  'wrap.aria': '自动换行',
  openWith: '打开方式',
  pdfEngineLoading: '正在加载 PDF 预览引擎…',
  pdfEngineFailed: 'PDF 预览引擎加载失败。',
  'viewer.text': '纯文本',
...
export const en = {
  ...
  'wrap.aria': 'Line wrap',
  openWith: 'Open with',
  pdfEngineLoading: 'Loading the PDF preview engine…',
  pdfEngineFailed: 'The PDF preview engine failed to load.',
